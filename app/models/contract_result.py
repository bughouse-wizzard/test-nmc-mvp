...
from sqlalchemy import Column, String, Integer, Enum, JSON, Boolean, Float, ForeignKey
...
class ContractResult(BaseModel):
    ...
    search_id = Column(String, ForeignKey("search_request.id", ondelete="CASCADE"), nullable=False, index=True)
