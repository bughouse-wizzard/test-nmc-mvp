...
from sqlalchemy import (JSON, Boolean, Column, Enum, Float, Integer, String,
                        Text)
...
class SearchRequest(BaseModel):
    ...
    contract_results = relationship(
        "ContractResult", back_populates="search_request", cascade="all, delete-orphan"
    )
